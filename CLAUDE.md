...
| A14 | Karma floor 0; spending only between sessions in a safe location; attribute step 10 then 20 above rank max | `store.spendKarma` | gates + tiered cost | karma test |
